...
import getNameFromResponse
response =getNameFromResponse.response
actual_list_of_president_names = getNameFromResponse.actual_list_of_president_names
actualLastName = getNameFromResponse.actualLastName
presidentLastNamesFromResponse = getNameFromResponse.presidentLastNamesFromResponse
